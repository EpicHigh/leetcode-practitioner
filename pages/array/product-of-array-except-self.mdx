...
The approach I showed earlier calculates the prefix and suffix products of each element in the input array nums, and then multiply the prefix and suffix products to get the final result. This approach has a time complexity of O(n) and a space complexity of O(n).
